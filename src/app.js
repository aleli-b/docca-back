...
server.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', CORS_DOMAIN, altDomain, "https://www.mercadopago.com.ar/", "https://mercadopago.com.ar/"); // Replace this with your frontend domain
